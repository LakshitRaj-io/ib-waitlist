...
const features = [
  {
    ...
    fullBody: "Every chat can be a task, appointment or an Action item. AIPA learns your life context and surfaces exactly what you need, when you need it — before you ask.",
    accentColor: "#3B82F6",
    bgColor: "#EFF6FF",
  },
  {
